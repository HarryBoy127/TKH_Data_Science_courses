...
#When I run the  print "hello world"  it doesnt work and say  File "<stdin>", line 1
    #print "hello world"
    #^^^^^^^^^^^^^^^^^^^ 
# it was confusing and didn't run properly  VS if I run it with parenthesis like print("hello world") it printed hello world 
...
when I use operations like + it works like math and ads 2+2 and give answer 4 

# 4. In math notation, leading zeros are ok, as in 09. What happens if you try
# this in Python?  What about 011?

looks like running 0 is not permitted on python but If i print("011") it shpws 011
